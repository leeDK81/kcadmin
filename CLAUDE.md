...
**사전 테스트 PROMAGE 조건 UX 통일 (2026-06-30):**
- PROMAGE 조건 선택: 위험/주의/양호/미설정 등급 버튼 → `✓ 충족 / ✗ 미충족` 토글 (MYDATA와 동일)
- 조건에 기댓값이 이미 명시(EQ 위험 등)되어 있어 등급 재선택 불필요
- `buildRuleCondRowsHTML` · `updateTestSummary` · `evaluateTestResult` 3곳 단순화
