...
상세·논의 경과는 `contents/decisions.md` "미결 항목" 표가 유일한 진실원 — 완료된 항목의 히스토리는 `contents/CHANGELOG.md`에 있으므로 여기 재서술하지 않는다. **2026-07-29 갱신 기준 실제 미결 4건:**
...
3. **B그룹 잔여 T30·T32**(2026-07-29) — 중환자실입원일당·장기입원비, 니치 특약이라 시장 데이터 희소. PM 권장: 급하지 않으면 보류. **"연령별" 세분화 리서치는 프로젝트 전체에서 매번 단일출처 벽에 부딪혀 구조적으로 불가능하다고 PM이 판단·권장(2026-07-29) — 사용자 명시 확인 대기, 확인되면 이 항목 자체를 종료 처리할 것.**
