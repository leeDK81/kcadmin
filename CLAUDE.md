...
상세는 `contents/decisions.md` 참조(2026-07-09 갱신 기준: T01 AND 조건 사각지대(고령층 세분화 자체는 이미 반영 완료), FAQ 서비스 이용 안내 3건 플레이스홀더). T01 나이 상한 65→85세 확장, EV038(T29 근거) 원문 재확인, 어린이보험 "아동보험"·"키즈보험" 유사어 6차 재검증, PASONA 후킹 설계 브리프 전체 카피 개정(23개 Risk-type·30개 Evidence·12개 Playbook) 항목은 2026-07-09 완료. 준법감시인(컴플라이언스) 검토 항목은 2026-07-09 삭제 — 오프라인 별도 프로세스로 처리돼 미결 추적 대상 아님(PO 판단). 2026-07-03 기준으로 여기 있던 "2순위 백로그·T25 재검증" 등은 이후 세션에서 전부 저작·해소됨 — 이 노트는 매번 `contents/decisions.md`의 실제 미결 항목과 대조해 갱신할 것(2026-07-07 정정 — 4일 지난 스냅샷이 방치돼 있었음).
