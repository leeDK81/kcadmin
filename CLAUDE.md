...
상세는 `contents/decisions.md` 참조(2026-07-29 6차 갱신 기준: FAQ 서비스 이용 안내 3건(FAQ-008~010) 플레이스홀더, 결과 카드 경각심 강화 방향(샘플 검토 대기), B그룹 잔여 2건(T30·T32) 이진 유지 — 니치 특약이라 시장 데이터 자체가 희소한 구조적 문제로 추정, 급하지 않으면 보류 가능). 부족형 전환 13건(T02·T05·T10·T25·T17·T24·T27·T28 + 2026-07-29 신규 T18·T21·T22·T29·T03·T04·T23·T26 중 A7200) 고객향 카피는 2026-07-29 4차로 완전 해소. B그룹 6건 중 4건(T03·T04·T23·T26)은 2026-07-29 6차 병렬 리서치로 전환 완료 — 상세는 CHANGELOG 참조. A5100(질병수술) 이진→부족형 미전환 사유는 2026-07-29 5차 `Data/maydata_date.pdf`(마이데이터 담보코드 공식 스펙) 확인으로 완전 해소 — A5100은 애초에 종별 세분화 필드가 아니라 단일 정액 코드이고, 종별 차등 지급은 별도 코드 A5109(질병종수술)의 영역임이 확정됨(A5300·A5309도 동일 구조). 이진 유지가 확정된 결론이라 재검토 불필요. A5508(인공관절수술)은 2026-07-29 PM 결정으로 해소 — 신규 Risk-type 신설 대신 기존 RU-T28을 이진→부족형(LTE 460만원)으로 전환. **2026-07-29 2차: 활성 Rule 23개 전수 감사** — 금액 임계값 적용 8개/순수 이진 15개 확인, 15개를 A(근거 있으나 미적용)/B(미확인)/C(권장금액 개념 미성립) 3그룹 분류. A그룹 4건(T18·T21·T29·T22) 전환 완료(상세는 CHANGELOG 참조), C그룹 3건(T20·T14·T11/T01)은 개념 자체가 안 맞아 미결 추적 제외 확정. 이 과정에서 A9500/A9509 대표코드 오배정(임플란트 값이 보존치료 코드에 잘못 배정)도 발견해 정정. 담보코드 참고금액 리서치 확장(연령대별 평균 가입금액, 2026-07-27 등록)은 2026-07-28 2차(핀테크 앱)·3차(KIDI·KLIA·KNIA·KIRI 공식통계) 조사까지 완료돼 해소됨 — A5100·A5508 신규 확인, 나머지 5개는 공식통계가 이 단위로는 애초에 공표되지 않는다는 구조적 사실 확인. T01 AND 조건 사각지대(실손 없음+사망보장 있음 미감지)는 2026-07-14 RU-T01 필수→선택 조건 재배치로 해소 완료(신규 카드 없이 처리 — T01·T11이 실손 유무로 이미 배타 분리돼 있던 구조 활용). T01 나이 상한 65→85세 확장, EV038(T29 근거) 원문 재확인, 어린이보험 "아동보험"·"키즈보험" 유사어 6차 재검증, PASONA 후킹 설계 브리프 전체 카피 개정(23개 Risk-type·30개 Evidence·12개 Playbook) 항목은 2026-07-09 완료. 준법감시인(컴플라이언스) 검토 항목은 2026-07-09 삭제 — 오프라인 별도 프로세스로 처리돼 미결 추적 대상 아님(PO 판단). mockups_v2 서비스 트랙 미결 5건(PROFILE 입력·Playbook 연결·FAQ 기준값·결과카드 실장·Case 0 세부)은 2026-07-14 목업 동결 방침에 따라 `context/decisions.md`에서 정리(개발팀 참고사항은 각 진실원 파일에 유지). 이 노트는 매번 `contents/decisions.md`의 실제 미결 항목과 대조해 갱신할 것.
