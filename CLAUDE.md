...
상세는 `contents/decisions.md` 참조(2026-07-07 갱신 기준: T01 고령층 세분화, 일부 Evidence 원문 재확인 권장, 준법감시인 실제 컴플라이언스 검토 미착수, FAQ 서비스 이용 안내 3건 플레이스홀더). 2026-07-03 기준으로 여기 있던 "2순위 백로그·T25 재검증" 등은 이후 세션에서 전부 저작·해소됨 — 이 노트는 매번 `contents/decisions.md`의 실제 미결 항목과 대조해 갱신할 것(2026-07-07 정정 — 4일 지난 스냅샷이 방치돼 있었음).
