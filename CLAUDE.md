...
contents/html/    ← KC카드 콘텐츠 어드민 (2026-07-02 신규, 아래 별도 섹션 참조)
...
## contents/html/ — KC카드 콘텐츠 어드민 (2026-07-02 신규)

KC카드 콘텐츠 입력 가이드 + Clark AI 채팅 답변 시뮬레이션.  
**mockups_v2/ 와 별개** — 서버 불필요, 브라우저에서 직접 열기 가능.
...
| 08_ai-preview.html | Clark AI 채팅 답변 시뮬레이션 (20개 체인) |
| sidebar.js | 좌측 공통 사이드바 JS 인젝션 (모든 파일 공유) |

### Clark AI 채팅 답변 흐름 (08_ai-preview 기준)
...
- 채팅 UI 표 렌더링 확인 — 실제 앱이 테이블 렌더링 불가 시 텍스트 리스트로 교체
- 각 상세 페이지 상단 카드 카운트 실제 수와 일치시키기
