...
| T12~T14 | (명칭은 컨텐츠 관리) | active |
| T15 | 자녀 건강보장 공백형 | 제거됨 (자녀 MYDATA 접근 구조적 불가) |
| T16 | 실손보험 노후화형 | 제거됨 (세대 구분 담보코드 없음) |
| T17~T19 | (명칭은 컨텐츠 관리) | active |
| T20 | 후유장해형 | active |
| T21 | 치과형 | active |
| T22 | 상해 특화형 | active |
| T23 | 골절형 | active |

> **비고**: T06 제거됨(갱신형 보험료 급등 — 갱신형 담보코드 MYDATA 미제공), T10 paused(시장 기준 개정 중). 운영 체인: 20개. T코드 명칭 상세는 컨텐츠(`contents/`) 관리 영역.
