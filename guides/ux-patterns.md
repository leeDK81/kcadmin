...
| 드라이런 | 사전 테스트 | |
| 임계값 | 기준값 / 판단 기준 | |
| KC Engine (운영자 화면) | Clark AI | 운영자에게 노출되는 텍스트 전용 |
| KC Engine (스펙·가이드 문서) | KC 엔진 | 개발자·기획 문서에서는 한글 표기 |
| 런타임 | (맥락에 맞게 풀어쓰기) | |
| 파라미터 | (맥락에 맞게 풀어쓰기) | |
| 라우팅 | (맥락에 맞게 풀어쓰기) | |
| 매핑 | (맥락에 맞게 풀어쓰기) | |
| 상/중/하 | 위험/주의/양호 | PROMAGE 등급 전용 |
| 고/중/저 | 위험/주의/양호 | PROMAGE 등급 전용 |
| (참고) 높음/보통/낮음 | — | Risk-type 중요도 서열 표기 — 상/중/하·고/중/저 대체어 아님 |
